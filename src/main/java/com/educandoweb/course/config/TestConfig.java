...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {// tudo que colocar na função sera executado quando a aplicação
		...
		/* intanciando category */
		Category cat1 = new Category(null, "Electronics");
		Category cat2 = new Category(null, "Books");
		Category cat3 = new Category(null, "Computers"); // rodar.
		/* salvando */
		categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));

		/* Associando product na category */
		...
		/* salvando associação no banco de dados*/
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
